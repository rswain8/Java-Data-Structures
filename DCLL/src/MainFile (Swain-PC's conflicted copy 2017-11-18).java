...
public class MainFile
{
	public static void main(String[]args)
	{
		...
		//only problem I found was that when i did two removes there was a infinite loop triggered somewhere (with a different set of data

		//data given to test yesterday outputs fine
		ll.addFirst("3");
		ll.addLast("8");
		ll.add(1,"4");
		ll.add(0,"8");
